...
apps =  read_delim("~/Duke/Duke Fall 2017/CS 316/dukeConversations/past_data/raw_apps.txt", "\t", escape_double = FALSE, trim_ws = TRUE)
...
write.csv(student, file = "application.csv")